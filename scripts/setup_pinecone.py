    ...
    def create_dense_index(self) -> bool:
        ...
        try:
            ...
            if self.dense_index_name in existing_indexes:
                logger.info(f"Index {self.dense_index_name} already exists, skipping creation")
                return True
            ...
            logger.info(f"Index {self.dense_index_name} created successfully: {response}")
            return True
    ...
    def create_sparse_index(self) -> bool:
        ...
        try:
            ...
            if self.sparse_index_name in existing_indexes:
                logger.info(f"Index {self.sparse_index_name} already exists, skipping creation")
                return True
            ...
            logger.info(f"Index {self.sparse_index_name} created successfully: {response}")
            return True

...
class OrganizationBase(BaseModel):
    ...
    urn: Optional[str] = Field(None, description="CMP Organization identifier (URN format)")
    social_links: Optional[List[str]] = Field(None, description="Social media URLs")
    feed_url: Optional[str] = Field(None, description="URL to organization's product feed")

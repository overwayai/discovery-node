...
class ProductGroupBase(BaseModel):
    ...
    product_group_id: str = Field(..., description="External identifier for the product group")
    varies_by: List[str] = Field(..., description="Dimensions that variants differ by (e.g. color, size)")
    ...
    category_id: Optional[UUID] = Field(None, description="Category ID for this product group")
    organization_id: UUID = Field(..., description="Organization this product group belongs to")

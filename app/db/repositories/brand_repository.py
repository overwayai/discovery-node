...
class BrandRepository:
    ...
    def get_by_name_and_org(self, name: str, organization_id: UUID) -> Optional[Brand]:
        ...
        return self.db_session.query(Brand).filter(
            Brand.name == name,
    ...
    def list_by_organization(self, organization_id: UUID, skip: int = 0, limit: int = 100) -> List[Brand]:
    ...
    def update(self, brand_id: UUID, brand_data: BrandUpdate) -> Optional[Brand]:
        ...
        brand_data_dict = brand_data.model_dump(exclude={"category_ids"}, exclude_unset=True)
    ...
    def list_by_category(self, category_id: UUID, skip: int = 0, limit: int = 100) -> List[Brand]:
        """List brands by category"""
        return self.db_session.query(Brand)\

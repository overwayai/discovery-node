...
class Brand(Base):
    ...
    urn = Column(String, unique=True, comment="CMP-specific brand identifier (URN format)")
    ...
    product_groups = relationship("ProductGroup", back_populates="brand", cascade="all, delete-orphan") 
